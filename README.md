Index_Fade SS7
=======
> Index_Fade SS7 top-level Squarespace development code.



## Project Overview
The Index_Fade project is a complex web-app built on the Squarespace developer platform introduced for Squarespace 7. This repo is used to build custom scripts, styles, layouts, and more for a developer-mode-enabled Squarespace site.
...
* **Top-level Code Repository** - Bitbucket
    * [AUTHOR_NAME's Bitbucket team](https://bitbucket.org/TEAM_SLUG/Index_Fade).
* **Production Website (indexfade-production)** - Squarespace
    * You need Administrator Permissions for  [https://indexfade-production.squarespace.com](https://indexfade-production.squarespace.com)
* **Development Website (indexfade-staging)** - Squarespace
    * You need Administrator Permissions for  [https://indexfade-staging.squarespace.com](https://indexfade-staging.squarespace.com)
...
When updates are ready for live testing, run `npm run deploy` to build the **Development** template. This will push your updates live to `https://indexfade-staging.squarespace.com`.



### Production

After updates have been live tested on the development website, we can get our work into production by running `npm run deploy:prod` to push our changes to the live production website located at `https://indexfade-production.squarespace.com`.
...
>
> * Starts Squarespace Server, using content from `https://indexfade-staging.squarespace.com` and serves files from `/build`.
>
...
`npm run server:live`
> Starts the Squarespace Server, using content from `https://indexfade-production.squarespace.com` and serves files from `/build`.
...
>
> ** _Make sure you select `https://indexfade-staging.squarespace.com` when prompted_.
...
> ** _Make sure you select `https://indexfade-production.squarespace.com` when prompted_.
> ** _This is_ **HIGHLY IMPORTANT!** _Select the wrong URL and you risk deploying code to an incorrect target_.
